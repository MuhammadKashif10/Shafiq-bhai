...
const services = [
  { icon: BookOpen, title: "IGCSE/O level Tutoring", desc: "Expert Cambridge IGCSE/O level preparation across all subjects. Our tutors are experienced with the Cambridge International curriculum and help students achieve top grades.", subjects: "Mathematics, Physics, Chemistry, Biology, English, Computer Science, Economics, Accounting" },
  { icon: GraduationCap, title: "AS/A Level Tutoring", desc: "Advanced-level coaching for university-bound students. We cover all major AS/A Level subjects with focus on exam technique and conceptual clarity.", subjects: "Mathematics, Further Maths, Physics, Chemistry, Biology, Economics, Business Studies, Psychology" },
